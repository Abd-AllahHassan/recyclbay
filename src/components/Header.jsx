      ...
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="md:hidden flex items-center space-x-2 space-x-reverse">
          <button
            onClick={togglePopup}
            aria-label="Cart"
            className="relative text-gray-700 hover:text-emerald-600 transition-colors duration-300 p-2 rounded-full"
          >
          ...
          <button
            ...
            className="text-gray-700 p-2 rounded-full hover:bg-emerald-50 transition-colors"
